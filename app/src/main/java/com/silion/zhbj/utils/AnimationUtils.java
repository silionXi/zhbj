...
public final class AnimationUtils {
     ...
     * @return 返回一个放大的效果
     */
    public static ScaleAnimation getAmplificationScaleAnimation(long durationMillis, AnimationListener animationListener) {
     ...
     * @return 返回一个放大的效果
     */
    public static ScaleAnimation getAmplificationScaleAnimation(long durationMillis) {
        return getAmplificationScaleAnimation(durationMillis, null);
     ...
     * @return 返回一个放大的效果
     */
    public static ScaleAnimation getAmplificationScaleAnimation(AnimationListener animationListener) {
        return getAmplificationScaleAnimation(DEFAULT_ANIMATION_DURATION,
                animationListener);
